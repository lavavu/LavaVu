...
class Viewer(dict):
    ...
    **kwargs
    ...
    def webgl(self, filename="webgl.html", resolution=(640,480), inline=True, menu=True, **kwargs):
        """        
        ...
        kwargs
            Additional named arguments passed will be added to the global model settings
        ...
        try:
            ...
            if not is_notebook(): inline = False
            if inline:
